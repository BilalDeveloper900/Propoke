const steps = [
  {
    number: '1.',
    title: 'View Listing',
    description: `Find your dream home with Solid Stay Properties Explore our exclusive listings featuring the best properties in prime locations. Whether you’re looking for a cozy apartment, a spacious family home, or a luxurious villa, we have the perfect option for you.`,
  },
  {
    number: '2.',
    title: 'Contact Us',
    ...
    <section className="bg-white px-4 sm:px-10 lg:px-0 py-10">
      <div   className="max-w-[1136px] grid sm:grid-cols-2 mx-auto items-center mb-12">
        <h2 className="text-[32px] md:text-[40px] font-bold text-[#333333] mb-4 max-w-[528px]">
          Easy Step to Buy Property on Solid Stay Properties
        </h2>

        <p className=" text-[#666666] text-base leading-[32px]">
          Buying your dream home with Solid Stay Properties is simple and hassle-free!
      ...
      <div   className='max-w-[1136px] mx-auto pt-6 '>
        <div className='flex flex-col sm:flex-row  justify-between items-center'>
          <div className='text-[#666666] text-base leading-[32px]'>
            Have questions about buying or selling a property with Solid Stay Properties? Check out our Frequently Asked Questions (FAQ).
          </div>
